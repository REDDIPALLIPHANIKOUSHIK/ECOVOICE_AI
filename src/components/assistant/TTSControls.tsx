import { Globe, VolumeX, Volume2 } from "lucide-react";
...
const TTSControls = ({
  ...
  <div className="flex items-center gap-3 px-3 py-2 bg-muted/50 rounded-xl text-xs flex-wrap border border-border/50">
